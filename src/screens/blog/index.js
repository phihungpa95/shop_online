                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-4 col-sm-6">
                            <div className="blog__item">
                                <div className="blog__item__pic large__item set-bg" data-setbg="img/blog/blog-1.jpg" />
                        ...
                        <div className="col-lg-4 col-md-4 col-sm-6">
                            ...
                            <div className="blog__item">
                                <div className="blog__item__pic set-bg" data-setbg="img/blog/blog-10.jpg" />
                                <div className="blog__item__text">
                        ...
                        <div className="col-lg-4 col-md-4 col-sm-6">
                            ...
                            <div className="blog__item">
                                <div className="blog__item__pic large__item set-bg" data-setbg="img/blog/blog-6.jpg" />
                                <div className="blog__item__text">
